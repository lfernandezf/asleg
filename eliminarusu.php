            ...
            <?php
			 ...
			 if($_GET['mensaje']==1)
			 {
			   ...
			   ?>
				...
				if ($_SESSION['user']=='admin'){
                    echo '<fieldset>';
					echo '<legend>eliminar  usuario de asleg </legend>';                    echo '   <form id="f-preingreso" method="post" action="elimusu.php">';
                    echo    '<label>Introdusca numero cedula de usuario a eliminar</label>';
                 echo'       <input type="text" name="cedula" size="15"  value=""required />';
					echo'	<center><input type="submit" class="button"  value="eliminar"></center>';
                  echo'      </form>';
			echo'	</fieldset>';
					}
                 ?>   
